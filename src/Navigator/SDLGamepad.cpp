...
std::array<GamepadButton, 16> SDLGamepad::getButtons()
{
  return std::array<GamepadButton, 16>(
      {getButton(SDL_CONTROLLER_BUTTON_A), getButton(SDL_CONTROLLER_BUTTON_B),
       ...
       getButton(SDL_CONTROLLER_BUTTON_RIGHTSHOULDER), getTrigger(SDL_CONTROLLER_AXIS_TRIGGERLEFT),
       getTrigger(SDL_CONTROLLER_AXIS_TRIGGERRIGHT), getButton(SDL_CONTROLLER_BUTTON_BACK),
       getButton(SDL_CONTROLLER_BUTTON_START), getButton(SDL_CONTROLLER_BUTTON_LEFTSTICK),
       getButton(SDL_CONTROLLER_BUTTON_RIGHTSTICK), getButton(SDL_CONTROLLER_BUTTON_DPAD_UP),
       getButton(SDL_CONTROLLER_BUTTON_DPAD_DOWN), getButton(SDL_CONTROLLER_BUTTON_DPAD_LEFT),
